...
class TestTaxiOrder:
    ...
    def open_taxi_order(self, main_page, route_page, taxi_page):
    ...
    def test_tariff_sleepy(self, taxi_page):
    ...
    def test_tariff_vacation(self, taxi_page):
    ...
    def test_tariff_talkative(self, taxi_page):
    ...
    def test_tariff_comfort(self, taxi_page):
    ...
    def test_tariff_glossy(self, taxi_page):
    ...
    def test_order_preparation_block_displayed(self, taxi_page):
